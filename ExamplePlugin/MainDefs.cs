...
namespace RPGMod
{
    struct MainDefs
    {
        ...
        public static List<string> questIconPaths = new List<string>() { "", "Assets/textures/coin.png", "Assets/textures/chest.png", "Assetst/textures/heal.png", "Assets/textures/aspects.png" };
